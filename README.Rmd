...
* **Asset Output:** [Download High-Resolution Vector (PDF)](./assets/rolling_totals.pdf)
...
* **`/script_pipeline.Rmd`**: The reproducible source code document utilizing custom `ggplot2` thematic object inheritance.
